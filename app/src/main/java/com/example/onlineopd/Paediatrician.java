...
public class Paediatrician extends AppCompatActivity {
    ...
    int[] images = {R.drawable.paediatrician1, R.drawable.paediatrician2, R.drawable.paediatrician3, R.drawable.paediatrician4, R.drawable.paediatrician5, R.drawable.paediatrician6};
...
//        toolbar.inflateMenu(R.menu.menu_menu);
        ...
        s1 = getResources().getStringArray(R.array.paeditrican);
    ...
    private void setOnClickListener() {
        listener  = new adapterCardio.recycleViewClickListener() {
            ...
            public void onClick(View v, int position) {
                if(position == 0)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician1);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();

                    Intent intent2 = new Intent(Paediatrician.this, Dr_joshi.class);
                ...
                if(position == 1)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician2);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==2)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician3);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==3)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician4);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==4)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician5);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==5)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.paediatrician6);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
