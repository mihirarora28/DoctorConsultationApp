...
public class Orthopaedic extends AppCompatActivity {
    Toolbar toolbar;
    RecyclerView ry2;
    String[] s1;
    String[] s2;
    ...
    int[] images = {R.drawable.orthopaedic1, R.drawable.orthopaedic2, R.drawable.orthopaedic3, R.drawable.orthopaedic4, R.drawable.orthopaedic5, R.drawable.orthopaedic6};
...
//        toolbar.inflateMenu(R.menu.menu_menu);
        ...
        s1 = getResources().getStringArray(R.array.orthonames);
    ...
    private void setOnClickListener() {
        listener  = new adapterCardio.recycleViewClickListener() {
            ...
            public void onClick(View v, int position) {
                if(position == 0) {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic1);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();

                    Intent intent2 = new Intent(Orthopaedic.this, Dr_joshi.class);
...
//                    startActivity(intent);
                ...
                if(position == 1)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic2);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==2)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic3);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==3)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic4);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==4)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic5);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
                ...
                if(position ==5)
                {
                    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.orthopaedic6);
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    bmp.compress(Bitmap.CompressFormat.PNG, 100, stream);
                    byte[] byteArray = stream.toByteArray();
